<div class="flex border">
    <div class="flex-1 px-10 border-right">
        <ul x-sort:group='easin'
        x-sort.ghost='console.log("group1: " + $item + " - " + $position)'
        role="list" class="divide-y divide-gray-100">
            <li x-sort:item='1' class="flex justify-between gap-x-6 py-5">
            ...
            <li x-sort:item='2' class="flex justify-between gap-x-6 py-5">
                <div class="flex min-w-0 gap-x-4">
            ...
            <li x-sort:item='3' class="flex justify-between gap-x-6 py-5">
                <div class="flex min-w-0 gap-x-4">
            ...
            <li x-sort:item='4' class="flex justify-between gap-x-6 py-5">
                <div class="flex min-w-0 gap-x-4">
            ...
            <li x-sort:item='5' class="flex justify-between gap-x-6 py-5">
                <div class="flex min-w-0 gap-x-4">
            ...
            <li x-sort:item='6' class="flex justify-between gap-x-6 py-5">
                <div class="flex min-w-0 gap-x-4">
            ...
            <div class="flex-1 px-10 border-right ml-20">
                <ul x-sort:group='easin' x-sort='console.log("group 2: " + $item + " - " + $position)' role="list" class="divide-y divide-gray-100">
                    <li x-sort:item='1' class="flex justify-between gap-x-6 py-5">
                        <div class="flex min-w-0 gap-x-4">
                            <img class="h-12 w-12 flex-none rounded-full bg-gray-50" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
                            <div class="min-w-0 flex-auto">
